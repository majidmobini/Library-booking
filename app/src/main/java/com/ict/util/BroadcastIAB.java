...
import static com.ict.util.IabHelper.IABHELPER_ERROR_BASE;
import static com.ict.util.IabHelper.IABHELPER_MISSING_TOKEN;
import static com.ict.util.IabHelper.RESPONSE_BUY_INTENT;
import static com.ict.util.IabHelper.getResponseDesc;

public class BroadcastIAB extends com.ict.util.IAB {
    ...
    private com.ict.util.IABReceiverCommunicator iabReceiver = null;
    ...
    BroadcastIAB(Context context, com.ict.util.IABLogger logger, String mSignatureBase64) {
        super(logger);
    ...
    private void createIABReceiver() {
        iabReceiver = new com.ict.util.IABReceiverCommunicator() {
            @Override
    ...
    private void handleLaunchPurchaseResponse(Bundle extras) {
        ...
        if (response != BILLING_RESPONSE_RESULT_OK) {
            ...
            flagEndAsync();
            com.ict.util.IabResult result = new com.ict.util.IabResult(response, "Unable to buy item");
    ...
    private void registerBroadcast() {
        com.ict.util.IABReceiver.addObserver(iabReceiver);
    }
    ...
    @Override
    void launchPurchaseFlow(Context mContext, Activity act, String sku, String itemType, int requestCode, com.ict.util.IabHelper.OnIabPurchaseFinishedListener listener, String extraData) {
    ...
    @Override
    void consume(Context mContext, com.ict.util.Purchase itemInfo) throws com.ict.util.IabException {
        String token = itemInfo.getToken();
        String sku = itemInfo.getSku();
        if (token == null || token.equals("")) {
            logger.logError("Can't consume " + sku + ". No token.");
            throw new com.ict.util.IabException(IABHELPER_MISSING_TOKEN, "PurchaseInfo is missing token for sku: "
                    + sku + " " + itemInfo);
        }
        ...
        try {
            ...
            if (consumePurchaseResponse == BILLING_RESPONSE_RESULT_OK) {
                ...
                throw new com.ict.util.IabException(consumePurchaseResponse, "Error consuming sku " + sku);
            }
        } catch (InterruptedException e) {
            throw new com.ict.util.IabException(IABHELPER_ERROR_BASE, "Error consuming sku " + sku);
        }
    }
    ...
    void dispose(Context context) {
        ...
        if (iabReceiver != null) {
            com.ict.util.IABReceiver.removeObserver(iabReceiver);
        }
        if (consumePurchaseLatch != null) {
